...
public final class Vector2 {
   ...
   *
   * @return double The Cartesian length of the vector.
   */
   ...
   *
   * @return A Vector2 object with a length of one and the same direction as
   *         <code>this</code>.
   */
  public Vector2 unit() {
    if (equals(ZERO)) {
  ...
  /**
   * Determine whether two Vector2s are parallel. For any vectors v1 and v2, v1 is parallel to v2
   * if and only if there is some value r such that rv1 = v2.
   *
   * @param vector The Vector2 to which <code>this</code> should be compared.
   ...
   *
   * @param vector The Vector2 whose dot product with <code>this</code> is to be
   *               taken.
   ...
   * Vector2. Read as "comp <code>this</code> on (other vector)".
   *
   ...
   * another Vector2. Read as "scalar comp <code>this</code> on (other vector)".
   *
   * @param vector A vector parallel to the desired vector component.
