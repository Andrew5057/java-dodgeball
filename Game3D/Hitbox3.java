...
public abstract class Hitbox3 {
     ...
     * 
     * @param   center  A Vector3 containing the x, y, and z coordinates of the Hitbox3's center.
     */
     ...
     * 
     * @param   center  A Vector3 containing the x, y, and z coordiantes of the new center.
     */
    ...
    /**
     * Determine if two Hitbox3 objects are equivalent. Two Hitbox3s are equivalent if they 
     * are of exactly the same class (not ancestors/descendants of each other) and they have 
    ...
    /**
     * Determine whether the Hitbox3 contains the point (x, y, z). Must be overriden.
     * 
