...
public class Camera {
    ...
    private Vector3 horizontal, vertical; // Vectors aligned horizontally & vertically w/ the viewplane
    
    /**
     * Define a Camera in terms of its current position in the 3D space and the direction in 
    ...
    /**
     * Define a Camera in terms of the coordintes of its current position and the components of its 
     * direction vector.
     */
     ...
     * 
     * @return  A Vector3 containing the Camera's x, y, and z coordinates, respectively.
     */
    public Vector3 position() {
        return position;
    }
    /**
     * Get the Vector3 representing the Camera's look vector. A Camera's look vector is the vector that 
     * it looks straight through.
     * 
     * @return  A Vector3 containing the x, y, and z coordinates of the Camera's look vector, 
     *          respectively.
     */
    ...
    /**
     * Set the Camera's position, given a Vector3 object that represents its new x, y, and z.
     * 
     * @param   position    A Vector3 containing the desired x, y, and z coordinates, respectively.
     */
    public void setPosition(Vector3 position) {
        this.position = position;
    }
    /**
     * Set the Camera's look vector, given a Vector3 object that represents its new x, y, and z.
     * 
     * @param   position    A Vector3 containing the desired x, y, and z coordinates, respectively.
     */
    ...
    /**
     * Translate the camera. Equivalent to adding the given vector to the camera's position vector.
     * 
    ...
    /**
     * Rotate the camera. Only available along the pitch (up-down) and yaw (left-right) axes.
     * 
    ...
    /**
     * Render a 3D point as a point on a 2D plane, according to the current position and direction 
     * of the camera.
     *
     * @param   point    A Vector3 containing the point's coordinates.
     * @return  The coordinates of the projection of the point on the viewplane and its distance from 
    ...
    public Vector3 render(Vector3 point) {
        ...
        // scaledVector is vector projected onto the plane that is 1 unit from the camera.
        ...
        // This obviously isn't the distance formula but since we're only using the depth 
        // comparatively, it's ok to square all the depth values and save ourselves the time of
    ...
    /**
     * Render a 3D polygon onto a 2D plane, according to the current position and direction of the 
     * camera.
     * 
     * @param   polygon A Polygon3 to be rendered.
     * @return  A Polygon3 where x- and y-values are coordinates on a plane and z-values are 
    ...
    /**
     * Render a 3D model onto a 2D plane, according to the current position and direction of the 
    ...
    public static Vector3 rotateLookVector(Vector3 vector, double yaw, double pitch) {
        ...
        newY = Math.tan(newPitch) * baseLength;
        
        // Saves time in the next step
        double sinYaw = Math.sin(yaw);
        double cosYaw = Math.cos(yaw);
        newX = vector.X*cosYaw + vector.Z*sinYaw;
        newZ = -vector.X*sinYaw + vector.Z*cosYaw;
