...
public class Projectile3 implements Cloneable {
     ...
     * @param   velocity    The velocity of the projectile in units per second as a Vector3.
     */
    ...
    /**
     * Updates the Projectile3 to have the position and velocity it will have a given number of 
     * seconds into the future.
     * 
     * @param   seconds The number of seconds in the future that the Projectile3 should be 
     *                  updated to. Should usually be the number of seconds that have passed 
     ...
     * 
     * @return  <code>true</code> if the Hitbox3 contains the Projectile3, <code>false</code>
     *          otherwise.
     */
